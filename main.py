...
# Prediction Page
    ...
    if test_image is not None:
        ...
        st.image(image, use_container_width=True)  # updated parameter here

        # Convert uploaded image to bytes and reload for prediction
        ...
        if st.button("Predict"):
            ...
            result_index = model_prediction(bytes_data)
